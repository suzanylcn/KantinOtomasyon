<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/Panel.Master" AutoEventWireup="true" CodeBehind="YoneticiGuncelle.aspx.cs" Inherits="KantinSite.YoneticiGuncelle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
	...
	<div class="col-md-4">
		...
		<asp:Button CssClass="btn btn-warning" ID="btnKaydet" Onclick="btnKaydet_Click" runat="server" Text="Kaydet" />
